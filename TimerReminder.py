    ...
    def convert_to_datetime(self, params, diff=False):
        ...
        if diff:
            ...
            for key in params.keys():
                if key == 'year' and dt['year'] > params['year']:
                ...
                elif key == 'hours' and dt['hours'] > params['hours']:
                    dt['day'] += 1
                    ...
                    dt[key] = params[key]
            res = datetime(dt['year'], dt['month'], dt['day'], dt['hours'], dt['minutes'], dt['seconds'])
        return res
...
if __name__ == '__main__':
    params = {'month': 5, 'day': 30, 'hours': 19, 'minutes': 30, 'seconds': 10}
